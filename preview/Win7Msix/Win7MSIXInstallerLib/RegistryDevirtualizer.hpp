...
namespace Win7MsixInstallerLib
{
	...
	public:
		...
		static HRESULT Create(_In_ std::wstring hiveFileName, _In_ MsixRequestImpl* msixRequest, _Out_ RegistryDevirtualizer** instance);
	...
	private:
		...
		RegistryDevirtualizer() {}
		RegistryDevirtualizer(_In_ std::wstring hiveFileName, _In_ MsixRequestImpl* msixRequest)
